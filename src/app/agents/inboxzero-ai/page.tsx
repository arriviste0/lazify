...
export default function InboxZeroDemoPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-blue-950/20 to-background py-8 px-4 md:px-6 flex flex-col items-center">
      ...
      <Card className="w-full max-w-3xl modern-card shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl font-bold text-primary">InboxZero AI Demo</CardTitle>
          <CardDescription className="text-lg text-muted-foreground mt-2">
            See how InboxZero AI can help you manage your emails intelligently.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <Textarea
                ...
                placeholder="e.g., Subject: Project Update - Can we meet next week to discuss progress on the new feature? Best, John"
          ...
          {result && (
            <Card className="mt-6 bg-primary/5 border-primary/20">
              <CardHeader>
                <CardTitle className="text-xl text-primary">InboxZero AI Suggests:</CardTitle>
              </CardHeader>
              <CardContent>
