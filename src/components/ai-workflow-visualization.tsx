...
// import { AnimatedBeam } from "@/components/magicui/animated-beam"; // Still commented out as per previous step

// Icons object with SVG definitions - keep at module level
const Icons = {
  notion: () => (
    <svg
      width="24"
    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          x2="50.0053945%"
          y2="100.013939%"
          id="gdocs-linearGradient-5-ai-viz"
        >
        ...
        <radialGradient
          ...
          id="gdocs-radialGradient-16-ai-viz"
        >
      ...
      <g fill="none" fillRule="evenodd">
        <mask id="gdocs-mask-2-ai-viz" fill="white">
          <use xlinkHref="#gdocs-path-1-ai-viz" />
        </mask>
        <path
          ...
          fill="#4285F4"
          mask="url(#gdocs-mask-2-ai-viz)"
        />
        <polygon
          fill="url(#gdocs-linearGradient-5-ai-viz)"
          mask="url(#gdocs-mask-2-ai-viz)"
        ...
        <path
          ...
          mask="url(#gdocs-mask-2-ai-viz)"
        />
        <g mask="url(#gdocs-mask-2-ai-viz)">
        ...
        <path
          d="M29.375,0 L4.40625,0 C1.9828125,0 0,1.99431818 0,4.43181818 L0,60.5681818 C0,63.0056818 1.9828125,65 4.40625,65 L42.59375,65 C45.0171875,65 47,63.0056818 47,60.5681818 L47,17.7272727 L29.375,0 Z"
          fill="url(#gdocs-radialGradient-16-ai-viz)"
        />
      </g>
    </svg>
  ),
  ...
  messenger: () => (
    ...
    >
      ...
      <path
        fill="url(#messenger-gradient-ai-viz)"
...
const AiWorkflowVisualization = () => {
  ...
  >(({ className, children }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "z-10 flex size-12 items-center justify-center rounded-full border-2 border-primary/30 bg-card p-3 shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all",
          className,
        )}
      >
        {children}
  ...
  const div4Ref = useRef<HTMLDivElement>(null); // OpenAI (Center)
