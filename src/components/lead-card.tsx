...
const getBadgeVariant = (score: number): 'default' | 'secondary' | 'destructive' | 'outline' => {
  if (score >= 75) return 'default'; // High relevance - Primary color (often green or blue in themes)
...
export function LeadCard({ companyName, contactPerson, relevanceScore }: LeadCardProps) {
